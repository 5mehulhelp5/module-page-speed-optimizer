 ...
 * of Page Speed Optimizer is published to the eTechFlow private Composer repo. Fires when
...
{
    private const PACKAGE     = 'etechflow/module-page-speed-optimizer';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-page-speed-optimizer.json';
    private const CACHE_KEY   = 'etechflow_pso_latest_version';
    private const CACHE_TTL   = 21600;
    private const LABEL       = 'Page Speed Optimizer';
